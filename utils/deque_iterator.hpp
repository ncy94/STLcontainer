...
namespace sc::utils{
    ...
    public:
        ...
        deque_iterator(T* ptr= nullptr, T** block = nullptr):iterator_base<T,deque_iterator>(ptr),
                first_(block == nullptr? nullptr: *block),
                last_(block == nullptr? nullptr: (*block+BLOCK_SIZE)),
                block_(block){}
